...
-- basic Snippets --
local checkBox = s('checkbox', {t('- [ ] ')})
table.insert(snippets, checkBox)

local checkBoxChecked = s('checkboxCheck', {t('- [x] ')})
table.insert(snippets, checkBoxChecked)

local mark = s('mark', {
  t('<mark>'), i(1, "text"), t('</mark>'), i(2, "") -- jump out of the angle brackets
})
table.insert(snippets, mark)

local tag = s('tag', {
  t('<'), i(1, "li"), t('>'), i(2, ""), t('</'), i(3, "li"), t('>'), i(4, "") -- jump out of the angle brackets
})
